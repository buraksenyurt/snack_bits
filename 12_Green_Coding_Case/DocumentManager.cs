...
public class DocumentManager
{
    ...
    {
        // Veritabanından işlem yapılması istenen doküman bilgisi çekilir       

        var dataTable = new DataTable();
        dataTable.Columns.Add("document_number", typeof(string));
        var dataRow = dataTable.NewRow();
        dataRow["document_number"] = "DOC-TMN-1024";
        dataTable.Rows.Add(dataRow);
        dataRow = dataTable.NewRow();
        dataRow["document_number"] = "DOC-TMN-1893";
        dataTable.Rows.Add(dataRow);
        Console.WriteLine($"{chargeSearch.DocumentNumber} Veritabanından işlem yapılacak ana döküman");
